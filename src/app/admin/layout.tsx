...
import { BarChart3, ShieldCheck, FileText, GraduationCap, Activity, Users, Brain } from 'lucide-react';
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    ...
    { name: '🧠 Admin AI', href: '/admin/ai', icon: Brain, current: pathname === '/admin/ai' },
